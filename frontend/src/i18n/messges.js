...
export const messages = {
  [LOCALES.ENGLISH]: {
    ...
    faq3Question: "Can I integrate your analytics via API?",
    faq3Answer:
    ...
    value2Header: "[ Openness ]",
    value2Text:
      "we create convenient solutions for all participants of the esports industry.",
    value3Header: "[ Partnership ]",
    value3Text:
      "we build long-term relationships with international and local companies.",
  ...
  [LOCALES.RUSSIAN]: {
    ...
    whatBenefits: "Какую пользу это приносит?",
    whatBenefitsText:
      "Больше не нужно вручную считать голы, киллы и прочие необходимые для трансляции метрики. Теперь это делают технологии компьютерного зрения. Автоматически. Без сна, отдыха и дорогостоящих ошибок.",
    step1Header:
      "Вы загружаете готовое видео или передаёте ссылку на трансляцию",
    step1Text: "От вас нужен только ваш медиаконтент. Больше ничего!",
    step2Header: "Система обрабатывает видеопоток",
    step2Text:
    ...
    step3Header: "Вы получаете аналитику вашего киберспортивного события",
    step3Text:
    ...
    faq1Question: "У вас есть лайв-аналитика по матчам?",
    faq1Answer:
    ...
    faq4Question: "Поддерживаете ли вы кастомные отчёты?",
    faq4Answer:
      "Конечно, мы можем формировать отчёты под запрос клиента — от базовых сводок до углублённой статистики по игрокам и картам.",
    ...
    marketplaceFaq7Question: "Как проверяется надежность продавцов?",
    marketplaceFaq7Answer:
      "Мы используем систему рейтингов и отзывов, проверяем юридический статус компаний и предоставляем доступ к истории завершенных сделок каждого продавца.",
    ...
    supportForWhomText:
      "Наши клиенты — организаторы киберспортивных мероприятий, бренды и правообладатели, которые хотят провести профессиональное событие «под ключ» без операционных сложностей.",
    supportWhatWeDo: "Что мы делаем?",
    supportWhatWeDoText:
      "Обеспечиваем полный цикл организации и производства: от логистики и технической подготовки до режиссуры эфира, графического оформления и послепродакшена.",
    supportBenefits: "Какую пользу это приносит?",
    supportBenefitsText:
      "Позволяет сосредоточиться на контенте и зрителях, а не на технических деталях. Профессиональное качество трансляции, снижение рисков и экономия ресурсов.",
    supportStep1Header: "Обсуждаем задачи и составляем план",
    supportStep1Text:
      "Проводим брифинг, согласовываем регламент, определяем цели и ключевые метрики вашего мероприятия.",
    supportStep2Header: "Организуем и проводим трансляцию",
    supportStep2Text:
      "Настраиваем оборудование, обеспечиваем мультикамерную съёмку, звук, графику и ведём эфир в реальном времени.",
    supportStep3Header: "Обрабатываем и монтируем контент",
    supportStep3Text:
      "Делаем клипы, нарезки, тизеры и готовим материалы для правообладателей. Помогаем с монетизацией прав на трансляцию.",
    supportFaq1Question: "Какие этапы мероприятия вы покрываете?",
    supportFaq1Answer:
      "Все: пре-продакшен (планирование, логистика), продакшен (трансляция, графика, звук) и пост-продакшен (монтаж, клипы, отчётность).",
    supportFaq2Question: "Можете работать с нашим существующим оборудованием?",
    supportFaq2Answer:
      "Да, мы адаптируемся под вашу инфраструктуру или предоставим своё оборудование — в зависимости от задач и технических требований.",
    supportFaq3Question: "Делаете ли вы графику и HUD для трансляции?",
    supportFaq3Answer:
      "Да, мы создаём кастомные оверлеи, HUD, lower thirds и другое графическое оформление, соответствующее стилю вашего бренда.",
    supportFaq4Question: "Как вы обеспечиваете стабильность трансляции?",
    supportFaq4Answer:
      "Дублируем critical-оборудование, мониторим качество в реальном времени и имеем протоколы быстрого реагирования на сбои.",
    supportFaq5Question:
      "Работаете ли вы с мультистримом (несколько платформ одновременно)?",
    supportFaq5Answer:
      "Да, мы настраиваем одновременную трансляцию на YouTube, Twitch, VK, OTT-платформы и другие каналы с адаптацией под каждую платформу.",
    supportFaq6Question: "Предоставляете ли вы монтаж после эфира?",
    supportFaq6Answer:
      "Да, мы делаем нарезки лучших моментов, клипы для соцсетей, полноценные записи матчей и готовим материалы для партнёров.",
    ...
    supportFaq10Question: "Как строится pricing?",
    supportFaq10Answer:
      "В зависимости от масштаба события: пакетные предложения «под ключ» или отдельные услуги. После брифинга готовим детальную смету.",

    companyName: "ТОО «СГЛ»",
    companyDescription:
      "участник международного технологического парка Astana Hub и разработчик инновационного проекта «Киберспортивная платформа SGL»",
    service1Header: "Разработка и внедрение программного обеспечения",
    service2Header: "Техническая поддержка и развитие цифровых решений",
    service3Header: "Интеграция и модификация продуктов под потребности рынка",
    service4Header:
